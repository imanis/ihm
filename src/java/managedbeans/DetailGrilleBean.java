...
public class DetailGrilleBean implements Serializable {
    ...
    public String edit() {
        System.out.println("------------------");
        return "editGrille?id=" + grille.getIdgrille() + "&faces-redirect=true";
    }
    ...
    public String del() {
        ...
        msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Succes", "Grille d'évaluation supprimée avec succes");
        FacesContext.getCurrentInstance().addMessage(null, msg);
        
        grille_s.delete(grille);
        grille = null;
        return "listGrille?faces-redirect=true";
    }
}
